...
module.exports.run = async (bot, message, args) => {
    ...
    .addField("General Info About The Bot", `This bot was created to server multiple servers. This bot was made by ${bot.users.get('329452869897945088').tag} This bot is still in beta so please be patient and wait for following updates!`);
