...
module.exports.run = async (bot, message, args) => {
    ...
    .setColor("#00ddff")
    .addField("You don't have a specified user.", `Please Specify a role to remove.\nd!removerole @DoctorMysterio <role>`);
    ...
    .setColor("#00ddff")
    .addField(`${rMember.user.username} doesn't have role:`, ` ${gRole.name}`);
    ...
    try{
        ...
        .setColor("#00ddff")
        .addField(`Your`, ` ${gRole.name} role has been taken!`);
        await rMember.send(roleSuccessDM)
    }catch(e){
    let roleSuccess = new Discord.RichEmbed()
    .setDescription("Warning!")
    .setColor("#00ddff")
    .addField(`${rMember}, ${gRole.name} has been taken!`)
